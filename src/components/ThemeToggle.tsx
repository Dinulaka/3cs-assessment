...
export default function ThemeToggle() {
  ...
  return (
    <button
      id="theme-toggle"
      onClick={toggleTheme}
      className="fixed top-6 right-6 z-50 flex items-center gap-2 px-4 py-2 text-sm font-medium tracking-wider uppercase transition-all duration-300 cursor-pointer"
      style={{
